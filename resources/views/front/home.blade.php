            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-12">
                    <div class="about-five-content">
                        ...
                        <h2 class="main-title fw-bold">{{ $about->title }}</h2>
                ...
                @foreach ($blogs as $blog)
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-news">
                            <div class="image">
                                <a href="javascript:void(0)"><img class="thumb" src="{{ $blog->image_url }}"
                                        alt="Blog" /></a>
                                <div class="meta-details">
                                    <img class="thumb" src="{{ asset('storage/' . $blog->auther_image) }}"
                                        alt="Author" />
                                    <span>BY {{ $blog->auther }}</span>
                                </div>
                            </div>
